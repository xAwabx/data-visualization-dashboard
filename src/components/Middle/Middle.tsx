...
const Middle: FC<MiddleProps> = ({}) => {
  return (
    <div className="flex flex-row gap-2  w-full bg-gray-300">
      <div className="flex flex-col justify-evenly bg-white shadow-sm shadow-black h-[45vh] w-[20vw] rounded-lg p-3 ">
        <div>
      ...
      <div className="flex flex-col justify-evenly bg-white shadow-sm shadow-black h-[45vh] w-[30vw] rounded-lg p-3 ">
        <div>
